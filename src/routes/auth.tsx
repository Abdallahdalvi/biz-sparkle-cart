...
export const Route = createFileRoute("/auth")({
  head: () => ({ meta: [{ title: "Sign In — Aghanims Phones and Gadgets" }, { name: "robots", content: "noindex" }] }),
  component: Auth,
});
    ...
    <SiteShell>
      <section className="max-w-md mx-auto py-16 px-margin-mobile">
        <h1 className="text-3xl font-bold text-primary mb-2">
          {mode === "signin" ? "Sign in to Aghanims Phones and Gadgets" : "Create your account"}
        </h1>
        ...
        <div className="bg-white shopify-border p-8 space-y-4">
          ...
          <div className="text-center text-[11px] text-on-surface-variant uppercase tracking-widest">
            or
          </div>

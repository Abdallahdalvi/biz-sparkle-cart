                  ...
                  {messages.map((msg) => (
                    ...
                    >
                      ...
                      <div className="pt-4 flex flex-wrap items-center gap-2.5">
                        <a
                          href={`https://mail.google.com/mail/?view=cm&fs=1&to=${msg.email}&su=${encodeURIComponent(msg.subject || "Aghanims Phones and Gadgets Inquiry")}`}
                          target="_blank"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        placeholder="Hi Aghanims Support, I have an inquiry regarding your products."
                        className="w-full bg-surface-container-low border border-outline-variant/40 p-3 text-sm font-medium focus:border-primary focus:outline-none"
                      />
                      <p className="text-[10px] text-on-surface-variant mt-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      placeholder="Aghanims Phones and Gadgets. PRECISION ENGINEERED LOGISTICS."
                      className="w-full bg-surface-container-low border border-outline-variant/40 p-3 text-sm font-medium focus:border-primary focus:outline-none"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      placeholder="© 2026 Aghanims Phones and Gadgets. ALL RIGHTS RESERVED."
                      className="w-full bg-surface-container-low border border-outline-variant/40 p-3 text-sm font-medium focus:border-primary focus:outline-none"
                    />
                  </div>
                </div>

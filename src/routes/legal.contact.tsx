...
export const Route = createFileRoute("/legal/contact")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Get in touch with TECHLAB support, grievance officer, and registered address.",
      },
    ],
  }),
  component: () => (
    <LegalPage title="Contact Us">
      ...
      <p>
        As required under Rule 5(9) of the IT Rules, 2011 and the Consumer Protection (E-Commerce)
        Rules, 2020:
      </p>
      <p>

  ...
  return (
    <SiteShell>
      ...
      <section className="relative bg-white overflow-hidden border-b border-outline-variant/20">
        <div className="relative z-10 w-full px-6 sm:px-12 lg:px-16 max-w-[1320px] mx-auto pt-10 pb-24 md:pt-16 md:pb-32 grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-16 items-center">
      ...
      <section className="bg-white py-12 md:py-16 border-y border-outline-variant/30">
        <div className="px-margin-mobile md:px-margin-desktop max-w-[1280px] mx-auto flex flex-col md:flex-row items-center gap-4 md:gap-20">

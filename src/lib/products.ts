...
export const DEFAULT_STOREFRONT_CMS: StorefrontCms = {
  ...
  biz_name: "Agahnim's Phones & Gadgets",
  biz_legal_name: "Agahnim's Phones & Gadgets Technologies LLP",
  biz_address: "Bandra Kurla Complex, Bandra East, Mumbai, 400051",
  biz_state: "Maharashtra",
  biz_gstin: "27AADCS1456Q1ZV",
  biz_email: "support@agahnims.example",
  ...
  footer_tagline: "Agahnim's Phones & Gadgets. PRECISION ENGINEERED LOGISTICS.",
  footer_copyright: "© 2026 Agahnim's Phones & Gadgets. ALL RIGHTS RESERVED.",
  reviews_api_key: "",
